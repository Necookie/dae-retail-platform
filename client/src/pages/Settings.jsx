...
import { Card, Form, Select, Input, Button, Typography, Divider, message, Row, Col, InputNumber } from 'antd'
...
const Settings = () => {
    ...
    return (
        <div>
            ...
            <Row gutter={[24, 24]}>
                <Col xs={24} lg={14}>
                    <Card title={<><SettingOutlined style={{ marginRight: 8 }} />System Settings</>} style={{ borderRadius: 12 }}>
                            ...
                            >
                                <Select>
                                    <Select.Option value="WEIGHTED_AVERAGE">
                                        Weighted Average — uses running avg cost per unit
                                    </Select.Option>
                                    <Select.Option value="LATEST_PURCHASE">
                                        Latest Purchase — uses most recent purchase price
                                    </Select.Option>
                                    <Select.Option value="MANUAL_OVERRIDE">
                                        Manual Override — uses manually set cost per material
                                    </Select.Option>
                                </Select>
                            </Form.Item>
                ...
                <Col xs={24} lg={10}>
                    <Card title="Costing Method Guide" style={{ borderRadius: 12 }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                            <div style={{ padding: '12px 16px', background: '#f0f4ff', borderRadius: 8, borderLeft: '4px solid #4f46e5' }}>
                                <Text strong>Weighted Average</Text>
                                <Text type="secondary" style={{ display: 'block', marginTop: 4, fontSize: 13 }}>
                                    Best for items with fluctuating prices. Averages historical purchase costs weighted by quantity. Recommended for bakeries.
                                </Text>
                            </div>
                            <div style={{ padding: '12px 16px', background: '#f0fdf4', borderRadius: 8, borderLeft: '4px solid #10b981' }}>
                            ...
                            <div style={{ padding: '12px 16px', background: '#fff7ed', borderRadius: 8, borderLeft: '4px solid #f59e0b' }}>
                    ...
                    <Card title="Current Active Settings" style={{ borderRadius: 12, marginTop: 24 }}>
